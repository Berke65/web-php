              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li><a href="contact.php" class="active"  title="İletişim">İletİşİm</a></li> 
                      </ul>        
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-4">
                    ...
                    <h5><a href="#">+90 555 444 33 22</a></h5>
                ...
                <div class="col-md-4">
                    ...
                    <h5><a href="#">info@sirketadi.com</a></h5>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div id="map">
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3010.7619630837357!2d28.977600075743656!3d41.008582971350535!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cab9be92011c27%3A0x236e6f6f37444fae!2sAyasofya%20Camii!5e0!3m2!1str!2str!4v1705899762793!5m2!1str!2str" width="100%" height="600px" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-xs-12">
                        ...
                        <form id="contact" action="" method="post">
                          <div class="row">
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <input name="name" type="text" id="name" placeholder="Adınız ve Soyadınız*" required="">
                              </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <input name="email" type="text" id="email" pattern="[^ @]*@[^ @]*" placeholder="Mail Adresiniz*" required="">
                              </fieldset>
                            </div>
